...
``` bash
$ serverless install --url https://github.com/AnomalyInnovations/serverless-nodejs-starter --name googleCalendar
```
...
``` bash
$ serverless invoke local --function events
```
